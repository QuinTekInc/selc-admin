...
class UserProfilePage extends StatelessWidget {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DetailContainer(
                              title: 'Full Name',
                              detail: Provider.of<SelcProvider>(context)
                                  .user
                                  .fullName),
                          const SizedBox(
                            height: 12,
                        ...
                        children: [
                          ...
                          ClickableMenuItem(
                              ...
                              onPressed: () => showCustomModalBottomSheet(
                                  context: context, child: EditNameSheet())),
                          const SizedBox(
                            height: 8,
                          ),
                          ClickableMenuItem(
                              ...
                              onPressed: () => showCustomModalBottomSheet(
                                  context: context, child: EditEmailSheet())),
                          const SizedBox(
                            height: 8,
                          ),
                          ClickableMenuItem(
  ...
  void handleLogout(BuildContext context) {
    ...
    try {
      Provider.of<SelcProvider>(context, listen: false).logout();
...
class _EditNameSheetState extends State<EditNameSheet> {
  ...
  void initState() {
    ...
    firstNameController.text =
        Provider.of<SelcProvider>(context, listen: false).user.firstName!;
    lastNameController.text =
        Provider.of<SelcProvider>(context, listen: false).user.lastName!;
  }
  ...
  void checkFields() {
    ...
    bool hasValuesChanged = firstNameController.text ==
            Provider.of<SelcProvider>(context, listen: false).user.firstName! &&
        lastNameController.text ==
            Provider.of<SelcProvider>(context, listen: false).user.lastName!;
    setState(() {
  ...
  void handleUpdate() async {
    ...
    try {
      await Provider.of<SelcProvider>(context, listen: false)
          .updateAccountInfo({
      ...
      showCustomAlertDialog(context,
          title: 'Error', contentText: 'An unexpected error occurred');
    }
  }
}
...
class _EditEmailSheetState extends State<EditEmailSheet> {
  ...
  void initState() {
    ...
    emailController.text =
        Provider.of<SelcProvider>(context, listen: false).user.email!;
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomText(
            'Change your account\'s email with a new and valid email address.'
          ),
          const SizedBox(
            height: 8,
          ),
  ...
  void checkFields() {
    ...
    bool hasValuesChanged = emailController.text ==
        Provider.of<SelcProvider>(context, listen: false).user.email!;
    setState(() {
      disableButton = isFieldsEmpty || hasValuesChanged;
    });
...
class _ChangePasswordSheetState extends State<ChangePasswordSheet> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomText(
              'Change your account\'s password by entering your old password.'),
          const SizedBox(
            height: 8,
          ),
          CustomTextField(
  ...
  void checkFields() {
    bool isFieldsEmpty = oldPasswordController.text.isEmpty ||
  ...
  void handleUpdate() async {
    ...
    try {
      ...
      showCustomAlertDialog(context,
          title: 'Error', contentText: 'An Unexpected Error occured.');
    } on Exception catch (e) {
      Navigator.pop(context); //closes the loading dialog
      showCustomAlertDialog(context, title: 'Error', contentText: e.toString());
    }
  }
}
