...
class _ReportWizardState extends State<ReportWizard> {
  ...
  void initState() {
    ...
    semesterController.value = widget.semester ?? Provider.of<SelcProvider>(context, listen: false).currentSemester;
    yearController.value = widget.year ?? Provider.of<SelcProvider>(context, listen: false).currentAcademicYear;
